...
export class BiasMitigationService {
  ...
  public createEnhancedPrompt(name: string, age: any, userInput: string): string {
    ...
    return `
      ...
      You're assisting a user named ${name}, age ${userAge}. Your task is to help with career advice, job listings, mentorship opportunities, and relevant community events. Keep your answers short and for job listings give 
